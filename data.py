...
db = client["Database_With_Description"]  # Replace "your_new_database_name" with your desired name
...
def update_inverted_index(link, words, description):
    # Extract the first 25 words of the description
...
def process_link(link_from_csv, description):
    ...
    if result:
        ...
        update_inverted_index(link_from_csv, words, description)
...
with zipfile.ZipFile(zip_file_path, 'r') as zip_file:
    for file_info in zip_file.infolist():
        with zip_file.open(file_info) as csv_file:
            ...
            if file_info.filename == "2015.csv":
